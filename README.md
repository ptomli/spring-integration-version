...
Your project uses Spring Integration 2.2.6.RELEASE, but something else you're
...
`spring-integration-version` `2.2.6.RELEASE` will result in any Spring
Integration transitive dependency being imported at `2.2.6.RELEASE`. Done,
finished and klaar!
